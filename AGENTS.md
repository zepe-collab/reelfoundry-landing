...
- Provide a protected visual management route at `/admin`; the public page remains readable without sign-in, while content edits and image uploads require the Site owner’s ChatGPT identity.
